...
async def _attempt(llm: LLMClient, description: str, image_urls: list[str] | None = None) -> Sentiment:
    raw = await llm.classify_sentiment(description, image_urls=image_urls)
